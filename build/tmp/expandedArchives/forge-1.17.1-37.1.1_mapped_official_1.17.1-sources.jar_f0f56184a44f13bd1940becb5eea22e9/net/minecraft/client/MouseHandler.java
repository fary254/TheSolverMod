               ...
               if (flag) {
                  ...
                  Screen.wrapScreenError(() -> {
                     ...
                     if (!aboolean[0]) {
                        ...
                        aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiMouseClickedPost(this.minecraft.screen, d0, d1, i, aboolean[0]);
                     }
                  ...
                  Screen.wrapScreenError(() -> {
                     ...
                     if (!aboolean[0]) {
                        ...
                        aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiMouseReleasedPost(this.minecraft.screen, d0, d1, i, aboolean[0]);
                     }
