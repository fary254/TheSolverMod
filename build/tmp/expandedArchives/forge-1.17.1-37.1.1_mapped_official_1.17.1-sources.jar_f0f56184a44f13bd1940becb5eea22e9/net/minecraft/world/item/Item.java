...
public class Item extends net.minecraftforge.registries.ForgeRegistryEntry<Item> implements ItemLike, net.minecraftforge.common.extensions.IForgeItem {
   ...
   public boolean isBarVisible(ItemStack p_150899_) {
      return p_150899_.getItem().showDurabilityBar(p_150899_);
   }

   public int getBarWidth(ItemStack p_150900_) {
      return Math.round(13.0F - ((float) p_150900_.getItem().getDurabilityForDisplay(p_150900_) * 13.0F));
   }

   public int getBarColor(ItemStack p_150901_) {
      return p_150901_.getItem().getRGBDurabilityForDisplay(p_150901_);
   }
